...
@class NSURL, FBSDKShareOpenGraphAction, NSArray, NSString;

@interface FBSDKShareOpenGraphContent : XXUnknownSuperclass <FBSDKSharingContent> {
	NSURL* _contentURL;
	NSArray* _peopleIDs;
	NSString* _placeID;
	NSString* _ref;
...
-(BOOL)isEqualToShareOpenGraphContent:(id)shareOpenGraphContent;
